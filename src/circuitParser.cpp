...
//      cout << "owner cell name: " << dnet->instance(i) << endl;
//      cout << "owner cell pin name: " << dnet->pin(i) << endl;
//      cout << "owner pin id: " << myPin->owner << endl;
...
//      cout << "port: " << myMacroPin->port.size() << endl;
      ...
      //MSK TEMP: 
      myPin->x_init_offset = myPin->x_offset;
      myPin->y_init_offset = myPin->y_offset;


//      cout << "calculated x_offset: " << myPin->x_offset << endl;
//      cout << "calculated y_offset: " << myPin->y_offset << endl;

      //MSK : cell port hash map
      cell* theCell = &ckt->cells[myPin->owner];
      theCell->ports.insert(make_pair(dnet->pin(i), myPin->id));
